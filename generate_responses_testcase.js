...
const prompts_testcase_json_file_name =
  parent_json_file_name + "_p_testcase.json";
const questions_prompts_path =
  "./prompts_testcase_json/" + prompts_testcase_json_file_name;
const questions_response_path =
  "./responses_testcase_json/" + parent_json_file_name + "_r_testcase.json";
