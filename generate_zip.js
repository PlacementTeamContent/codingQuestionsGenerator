...
const jsonFilePath = "./coding_responses/" + parent_json_file_name + "_coding.json";
const output_zip_files_path = "./output_zip_files";
const newFolderPath = output_zip_files_path + "/Coding Questions";
...
archive.directory(newFolderPath, "Coding Questions");
